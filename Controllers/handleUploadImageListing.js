...
req.files.propertyImages.forEach(element => {
    ...
    allImages.push(`http://127.0.0.1:8000/public/Assets/ListingImages/${element.filename}`)
});

    // Save the thumbnail and all images
    const thumbnail = 'http://127.0.0.1:8000/public/Assets/ListingImages/'+req.files.thumbnail[0]['filename'];
