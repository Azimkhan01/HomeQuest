...
const signupUser = async (req, res) => {
  ...
  if (
    ...
    (await req.body.username) == undefined ||
    (await req.body.password) == undefined
  ) {
    res.render("signup", {
    ...
    if ((await req.body.email) == "") {
      console.log(
        colors.bgYellow(
          "email entered is required /'null/' entered return to signup page"
        )
      );
      res.render("signup", {
      ...
      console.log(
        colors.bgYellow("email entered is already exist return to signup page")
      );
      res.render("signup", {
