...
async function handleAppointment(agentMail, agentName, agentID) {
  {
    ...
    const response = await fetch(
      `${window.location.protocol}//${window.location.hostname}:${window.location.port}/handleAppointment`,
      {
        method: "POST",
        headers: {
      ...
      s += `
          <div class="agent-card">
                <div class="agent-info">
                    <div>
                        <h2 class="Agent-title"><i class="fa-solid fa-user"></i>
                            ${e.username}</h2>
                        <!-- <p>
                        ...
                        <div class="agent-info-ul-appointment">
                            <ul>
                                ...
                                <li><strong>Specialty:</strong> Residential
                                    Properties</li>
                                <li><strong>Contact <i
                                            class="fa-solid fa-envelope"></i>:</strong>
                                    ${e.email}</li>
                            </ul>
                            <div class="sendAppointmentBtn">
                                <button onclick='handleAppointment("${e.email}", "${e.username}","${e["_id"]}")' id=${e["_id"]} class="button" style="--clr: #00ad54;">
                                    ...
                                    <div class="button-content">
                                        ...
                                        <span
                                            class="button__text">Appointment</span>
                                    </div>
                                </button>
                            </div>
                        </div>

                        <h2>Many People Viewed</h2>
                    </div>
                    ...
                    <div class="popular-listing">
                        ...
                        <a href="#">
                            <div class="popular-listing-img">
                                <img
                                    src="https://demo.htmlcodex.com/2259/real-estate-html-template/img/property-1.jpg"
                                    alt="Property Image">
                            </div>
                            <div class="popular-listing-info">
                                <p><i class="fa-solid fa-eye"></i> This is
                                    title</p>
                            </div>
                        </a>
                        <a href="#">
                ...
                <!-- Right-side Image Section (Agent's Image) -->
                <div class="agent-img">
                    <div class="main-img">
                        <img src=${window.location.protocol}//${window.location.hostname}:${window.location.port}${e.image}
                            alt="Agent Image">
                    </div>
                    <div class="more-info">
                        <ul class="example-2">
